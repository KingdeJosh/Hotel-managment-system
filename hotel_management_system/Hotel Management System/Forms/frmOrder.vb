...
Public Class frmOrder
    ...
    Sub Print()
        Try
            ...
            rpt.SetParameterValue("var1", txtGuestName.Text)
            rpt.SetParameterValue("var2", txtRoomNo.Text)
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cb As String = "insert into Room_OrderInfo( Id, BillNo, BillDate, CheckInId, GrandTotal, TotalPayment, PaymentDue) Values (" & txtBillID.Text & ",'" & txtBillNo.Text & "',@d1," & txtCheckedInID.Text & "," & txtGrandTotal.Text & "," & txtTotalPayment.Text & "," & txtPaymentDue.Text & ")"
    ...
    Private Sub btnGetData_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGetData.Click
        frmOrdersRecord.lblSet.Text = "Order"
        frmOrdersRecord.Reset()
        frmOrdersRecord.ShowDialog()
    End Sub

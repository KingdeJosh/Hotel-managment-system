...
Public Class frmLiquorCategory
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            con.Open()
            Dim ct As String = "select CategoryName from Category_Liquor where CategoryName=@d1"
            ...
            Dim cb As String = "insert into Category_Liquor(CategoryName,VAT,ST) VALUES (@d1," & txtVAT.Text & "," & txtServiceTax.Text & ")"
    ...
    Private Sub DeleteRecord()
        ...
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cl As String = "select CategoryName from Liquor,Category_Liquor where Liquor.Category=Category_Liquor.CategoryName and CategoryName=@d1"
            cmd = New SqlCommand(cl)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", txtCategoryName.Text)
            rdr = cmd.ExecuteReader()
            If rdr.Read Then
                MessageBox.Show("Unable to delete..Already in use in Liquor Entry", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cq As String = "delete from Category_Liquor where CategoryName=@d1"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cb As String = "update Category_Liquor set CategoryName=@d1,VAT=" & txtVAT.Text & ",ST=" & txtServiceTax.Text & " where CategoryName=@d2"
            cmd = New SqlCommand(cb)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", txtCategory.Text)
    ...
    Public Sub Getdata()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(CategoryName), RTRIM(VAT), RTRIM(ST) from Category_Liquor order by CategoryName", con)

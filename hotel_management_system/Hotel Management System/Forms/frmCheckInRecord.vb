...
Public Class frmCheckInRecord
    Sub fillRoomNo()
        Try
            ...
            adp.SelectCommand = New SqlCommand("SELECT distinct RTRIM(RoomNo) FROM CheckIN_Room", CN)
            ds = New DataSet("ds")
            adp.Fill(ds)
            dtable = ds.Tables(0)
        ...
        Try
            If dgw.Rows.Count > 0 Then
                If lblSet.Text = "Check In" Then
                    ...
                    frmCheckIN_Room.txtCheckInID.Text = dr.Cells(0).Value.ToString()
                    frmCheckIN_Room.txtGuestID.Text = dr.Cells(1).Value.ToString()
                    frmCheckIN_Room.txtGuestName.Text = dr.Cells(2).Value.ToString()
                    frmCheckIN_Room.cmbRoomNo.Text = dr.Cells(3).Value.ToString()
                    frmCheckIN_Room.cmbRoomNo1.Text = dr.Cells(3).Value.ToString()
                    frmCheckIN_Room.txtRoomCharges.Text = dr.Cells(4).Value.ToString()
                    frmCheckIN_Room.dtpDateIn.Text = dr.Cells(5).Value.ToString()
                    frmCheckIN_Room.dtpDateOut.Text = dr.Cells(6).Value.ToString()
                    frmCheckIN_Room.txtNoOfDays.Text = dr.Cells(7).Value.ToString()
                    frmCheckIN_Room.txtNoOfMales.Text = dr.Cells(8).Value.ToString()
                    frmCheckIN_Room.txtNoOfFemales.Text = dr.Cells(9).Value.ToString()
                    frmCheckIN_Room.txtNoOfKids.Text = dr.Cells(10).Value.ToString()
                    frmCheckIN_Room.txtNoOfExtraBed.Text = dr.Cells(11).Value.ToString()
                    frmCheckIN_Room.txtNoOfExtraPerson.Text = dr.Cells(12).Value.ToString()
                    frmCheckIN_Room.txtRoomOrderCharges.Text = dr.Cells(13).Value.ToString() + Val(txtRoomCharges.Text)
                    frmCheckIN_Room.txtExtraPersonCharges.Text = dr.Cells(14).Value.ToString()
                    frmCheckIN_Room.txtTotalRoomCharges.Text = dr.Cells(15).Value.ToString()
                    frmCheckIN_Room.txtExtraBedCharges.Text = dr.Cells(16).Value.ToString()
                    frmCheckIN_Room.txtLaundryCharges.Text = dr.Cells(17).Value.ToString()
                    frmCheckIN_Room.txtDiscountPer.Text = dr.Cells(18).Value.ToString()
                    frmCheckIN_Room.txtDiscountAmount.Text = dr.Cells(19).Value.ToString()
                    frmCheckIN_Room.txtServiceTaxPer.Text = dr.Cells(20).Value.ToString()
                    frmCheckIN_Room.txtServiceTaxAmount.Text = dr.Cells(21).Value.ToString()
                    frmCheckIN_Room.txtLuxuryTaxPer.Text = dr.Cells(22).Value.ToString()
                    frmCheckIN_Room.txtLuxuryTaxAmount.Text = dr.Cells(23).Value.ToString()
                    frmCheckIN_Room.txtSubTotal.Text = dr.Cells(24).Value.ToString()
                    Dim num1, num2, num3 As Double
                    num1 = CDbl(dr.Cells(25).Value)
                    num1 = Math.Round(num1, 2)
                    num2 = CDbl(dr.Cells(26).Value)
                    num2 = Math.Round(num2, 2)
                    num3 = CDbl(dr.Cells(27).Value)
                    num3 = Math.Round(num3, 2)
                    frmCheckIN_Room.txtGrandTotal.Text = num1
                    frmCheckIN_Room.txtTotalPaid.Text = num2
                    frmCheckIN_Room.txtBalance.Text = num3
                    If dr.Cells(28).Value.ToString() = "Yes" Then
                        frmCheckIN_Room.CheckBox1.Checked = True
                    End If
                    If dr.Cells(28).Value.ToString() = "No" Then
                        frmCheckIN_Room.CheckBox1.Checked = False
                    End If
                    frmCheckIN_Room.txtNotes.Text = dr.Cells(29).Value.ToString()
                    con = New SqlConnection(cs)
                    con.Open()
                    cmd = con.CreateCommand()
                    cmd.CommandText = "SELECT ID, Address, City, ContactNo, Gender, Occupation, Religion, IDType, IDNumber from Guest WHERE GuestId='" & dr.Cells(1).Value & "'"
                ...
                If lblSet.Text = "Check Out" Then
                    ...
                    con.Open()
                    cmd = con.CreateCommand()
                    cmd.CommandText = "SELECT sum(PaymentDue) FROM CheckIN_Room,Room_OrderInfo where Room_Orderinfo.CheckInId=Checkin_Room.Cin_ID and Checkin_Room.Cin_ID= " & dr.Cells(0).Value.ToString() & ""
                    rdr = cmd.ExecuteReader()
                    If rdr.Read() Then
                        txtRoomCharges.Text = rdr.GetValue(0).ToString()
                    Else
                    ...
                    ' or simply use column name instead of index
                    'dr.Cells["id"].Value.ToString();
                    frmCheckOut_Room.txtCheckInID.Text = dr.Cells(0).Value.ToString()
                    frmCheckOut_Room.txtGuestID.Text = dr.Cells(1).Value.ToString()
                    frmCheckOut_Room.txtGuestName.Text = dr.Cells(2).Value.ToString()
                    frmCheckOut_Room.txtRoomNo.Text = dr.Cells(3).Value.ToString()
                    frmCheckOut_Room.txtRoomCharges.Text = dr.Cells(4).Value.ToString()
                    frmCheckOut_Room.dtpDateIn.Text = dr.Cells(5).Value.ToString()
                    frmCheckOut_Room.dtpDateOut.Text = dr.Cells(6).Value.ToString()
                    frmCheckOut_Room.txtNoOfDays.Text = dr.Cells(7).Value.ToString()
                    frmCheckOut_Room.txtNoOfMales.Text = dr.Cells(8).Value.ToString()
                    frmCheckOut_Room.txtNoOfFemales.Text = dr.Cells(9).Value.ToString()
                    frmCheckOut_Room.txtNoOfKids.Text = dr.Cells(10).Value.ToString()
                    frmCheckOut_Room.txtNoOfExtraBed.Text = dr.Cells(11).Value.ToString()
                    frmCheckOut_Room.txtNoOfExtraPerson.Text = dr.Cells(12).Value.ToString()
                    frmCheckOut_Room.txtRoomOrderCharges.Text = dr.Cells(13).Value.ToString() + Val(txtRoomCharges.Text)
                    frmCheckOut_Room.txtExtraPersonCharges.Text = dr.Cells(14).Value.ToString()
                    frmCheckOut_Room.txtTotalRoomCharges.Text = dr.Cells(15).Value.ToString()
                    frmCheckOut_Room.txtExtraBedCharges.Text = dr.Cells(16).Value.ToString()
                    frmCheckOut_Room.txtLaundryCharges.Text = dr.Cells(17).Value.ToString()
                    frmCheckOut_Room.txtDiscountPer.Text = dr.Cells(18).Value.ToString()
                    frmCheckOut_Room.txtDiscountAmount.Text = dr.Cells(19).Value.ToString()
                    frmCheckOut_Room.txtServiceTaxPer.Text = dr.Cells(20).Value.ToString()
                    frmCheckOut_Room.txtServiceTaxAmount.Text = dr.Cells(21).Value.ToString()
                    frmCheckOut_Room.txtLuxuryTaxPer.Text = dr.Cells(22).Value.ToString()
                    frmCheckOut_Room.txtLuxuryTaxAmount.Text = dr.Cells(23).Value.ToString()
                    frmCheckOut_Room.txtSubTotal.Text = dr.Cells(24).Value.ToString()
                    frmCheckOut_Room.txtGrandTotal.Text = dr.Cells(25).Value.ToString()
                    frmCheckOut_Room.txtTotalPaid.Text = dr.Cells(26).Value.ToString()
                    frmCheckOut_Room.txtBalance.Text = dr.Cells(27).Value.ToString()
                    If dr.Cells(28).Value.ToString() = "Yes" Then
    ...
    Private Sub txtGuestName_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtGuestName.TextChanged
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("Select RTRIM(CheckIn_Room.Cin_Id) as [Check In ID], RTRIM(Guest.GuestID) as [Guest ID],RTRIM(GuestName) as [Guest Name],RTRIM(Room. RoomNo) as [Room No.], RTRIM(CheckIN_Room.RoomCharges) as [Room Charges], Convert(DateTime,DateIN,103) as [Date IN], Convert(DateTime,DateOUT,103) as [Date Out], RTRIM(NoOfDays) as [No. Of Days], RTRIM(NoOfMales) as [No. Of Males], RTRIM(NoOfFemales) as [No. Of Females], RTRIM(NoOfKids) as [No. Of Kids], RTRIM(NoOfExtraBed) as [No. Of Extra Bed], RTRIM(NoOfExtraPerson) as [No. Of Extra Person], RTRIM(RoomOrderCharges) as [Room Order Charges], RTRIM(ExtraPersonCharges) as [Extra Person Charges], RTRIM(TotalRoomCharges) as [Total Room Charges],RTRIM(ExtraBedCharges) as [Extra Bed Charges], RTRIM(OtherCharges) as [Laundry Charges], RTRIM(DiscountPer) as [Discount %], RTRIM(DiscountAmount) as [Discount Amount], RTRIM(STPer) as [ST %], RTRIM(STAmount) as [ST Amount], RTRIM(LuxuryTaxPer) as [Luxury Tax Per],RTRIM( LuxuryTaxAmount) as [Luxury Tax Amount], RTRIM(SubTotal) as [Sub Total], RTRIM(GrandTotal) as [Grand Total], RTRIM(TotalPaid) as [Total Paid], RTRIM(Balance) as [Balance], RTRIM(TaxPaidRate) as [Tax Paid Rate], RTRIM(CheckIn_Room.Notes) as [Notes] from Guest,Room,CheckIN_Room where Guest.ID=CheckIN_Room.GuestID and Status='Check In' and Room.RoomNo=CheckIn_Room.RoomNo and GuestName like '" & txtGuestName.Text & "%' Order by DateIN", con)
            Dim myDA As SqlDataAdapter = New SqlDataAdapter(cmd)
            Dim myDataSet As DataSet = New DataSet()
            myDA.Fill(myDataSet, "Guest")
            myDA.Fill(myDataSet, "Room")
    ...
    Private Sub cmbRoomNo_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbRoomNo.SelectedIndexChanged
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("Select RTRIM(CheckIn_Room.Cin_Id) as [Check In ID], RTRIM(Guest.GuestID) as [Guest ID],RTRIM(GuestName) as [Guest Name],RTRIM(Room. RoomNo) as [Room No.], RTRIM(CheckIN_Room.RoomCharges) as [Room Charges], Convert(DateTime,DateIN,103) as [Date IN], Convert(DateTime,DateOUT,103) as [Date Out], RTRIM(NoOfDays) as [No. Of Days], RTRIM(NoOfMales) as [No. Of Males], RTRIM(NoOfFemales) as [No. Of Females], RTRIM(NoOfKids) as [No. Of Kids], RTRIM(NoOfExtraBed) as [No. Of Extra Bed], RTRIM(NoOfExtraPerson) as [No. Of Extra Person], RTRIM(RoomOrderCharges) as [Room Order Charges], RTRIM(ExtraPersonCharges) as [Extra Person Charges], RTRIM(TotalRoomCharges) as [Total Room Charges],RTRIM(ExtraBedCharges) as [Extra Bed Charges], RTRIM(OtherCharges) as [Laundry Charges], RTRIM(DiscountPer) as [Discount %], RTRIM(DiscountAmount) as [Discount Amount], RTRIM(STPer) as [ST %], RTRIM(STAmount) as [ST Amount], RTRIM(LuxuryTaxPer) as [Luxury Tax Per],RTRIM( LuxuryTaxAmount) as [Luxury Tax Amount], RTRIM(SubTotal) as [Sub Total], RTRIM(GrandTotal) as [Grand Total], RTRIM(TotalPaid) as [Total Paid], RTRIM(Balance) as [Balance], RTRIM(TaxPaidRate) as [Tax Paid Rate], RTRIM(CheckIn_Room.Notes) as [Notes] from Guest,Room,CheckIN_Room where Guest.ID=CheckIN_Room.GuestID and Status='Check In' and Room.RoomNo=CheckIn_Room.RoomNo and Room.RoomNo=@d1 Order by DateIN", con)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("Select RTRIM(CheckIn_Room.Cin_Id) as [Check In ID], RTRIM(Guest.GuestID) as [Guest ID],RTRIM(GuestName) as [Guest Name],RTRIM(Room. RoomNo) as [Room No.], RTRIM(CheckIN_Room.RoomCharges) as [Room Charges], Convert(DateTime,DateIN,103) as [Date IN], Convert(DateTime,DateOUT,103) as [Date Out], RTRIM(NoOfDays) as [No. Of Days], RTRIM(NoOfMales) as [No. Of Males], RTRIM(NoOfFemales) as [No. Of Females], RTRIM(NoOfKids) as [No. Of Kids], RTRIM(NoOfExtraBed) as [No. Of Extra Bed], RTRIM(NoOfExtraPerson) as [No. Of Extra Person], RTRIM(RoomOrderCharges) as [Room Order Charges], RTRIM(ExtraPersonCharges) as [Extra Person Charges], RTRIM(TotalRoomCharges) as [Total Room Charges],RTRIM(ExtraBedCharges) as [Extra Bed Charges], RTRIM(OtherCharges) as [Laundry Charges], RTRIM(DiscountPer) as [Discount %], RTRIM(DiscountAmount) as [Discount Amount], RTRIM(STPer) as [ST %], RTRIM(STAmount) as [ST Amount], RTRIM(LuxuryTaxPer) as [Luxury Tax Per],RTRIM( LuxuryTaxAmount) as [Luxury Tax Amount], RTRIM(SubTotal) as [Sub Total], RTRIM(GrandTotal) as [Grand Total], RTRIM(TotalPaid) as [Total Paid], RTRIM(Balance) as [Balance], RTRIM(TaxPaidRate) as [Tax Paid Rate], RTRIM(CheckIn_Room.Notes) as [Notes] from Guest,Room,CheckIN_Room where Guest.ID=CheckIN_Room.GuestID and Room.RoomNo=CheckIn_Room.RoomNo and Status='Check In' and DateIN between @d1 and @d2 Order by DateIN", con)
    ...
    Private Sub cmbStatus_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles cmbStatus.SelectedIndexChanged
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("Select RTRIM(CheckIn_Room.Cin_Id) as [Check In ID], RTRIM(Guest.GuestID) as [Guest ID],RTRIM(GuestName) as [Guest Name],RTRIM(Room. RoomNo) as [Room No.], RTRIM(CheckIN_Room.RoomCharges) as [Room Charges], Convert(DateTime,DateIN,103) as [Date IN], Convert(DateTime,DateOUT,103) as [Date Out], RTRIM(NoOfDays) as [No. Of Days], RTRIM(NoOfMales) as [No. Of Males], RTRIM(NoOfFemales) as [No. Of Females], RTRIM(NoOfKids) as [No. Of Kids], RTRIM(NoOfExtraBed) as [No. Of Extra Bed], RTRIM(NoOfExtraPerson) as [No. Of Extra Person], RTRIM(RoomOrderCharges) as [Room Order Charges], RTRIM(ExtraPersonCharges) as [Extra Person Charges], RTRIM(TotalRoomCharges) as [Total Room Charges],RTRIM(ExtraBedCharges) as [Extra Bed Charges], RTRIM(OtherCharges) as [Laundry Charges], RTRIM(DiscountPer) as [Discount %], RTRIM(DiscountAmount) as [Discount Amount], RTRIM(STPer) as [ST %], RTRIM(STAmount) as [ST Amount], RTRIM(LuxuryTaxPer) as [Luxury Tax Per],RTRIM( LuxuryTaxAmount) as [Luxury Tax Amount], RTRIM(SubTotal) as [Sub Total], RTRIM(GrandTotal) as [Grand Total], RTRIM(TotalPaid) as [Total Paid], RTRIM(Balance) as [Balance], RTRIM(TaxPaidRate) as [Tax Paid Rate], RTRIM(CheckIn_Room.Notes) as [Notes] from Guest,Room,CheckIN_Room where Guest.ID=CheckIN_Room.GuestID and Room.RoomNo=CheckIn_Room.RoomNo and Status=@d1 Order by DateIN", con)

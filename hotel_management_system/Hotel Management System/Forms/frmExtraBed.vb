...
Public Class frmExtraBed
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        Try
            ...
            Dim cb As String = "insert into ExtraBed(RoomType,Charges) VALUES (@d1," & txtChargesPerDay.Text & ")"
    ...
    Private Sub btnUpdate_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnUpdate.Click
        Try
            ...
            con = New SqlConnection(cs)
            con.Open()
            Dim cb As String = "update ExtraBed set RoomType=@d1,Charges=" & txtChargesPerDay.Text & " where RoomType=@d2"
            cmd = New SqlCommand(cb)
            cmd.Connection = con
            cmd.Parameters.AddWithValue("@d1", cmbRoomType.Text)
            ...
            cmd.ExecuteReader()
            con.Close()
            Dim st As String = "updated the ExtraBed details for room type '" & cmbRoomType.Text & "'"
            LogFunc(lblUser.Text, st)
            MessageBox.Show("Successfully updated", "ExtraBed Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
            btnUpdate.Enabled = False
            Getdata()
        Catch ex As Exception
            MessageBox.Show(ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.[Error])
    ...
    Public Sub Getdata()
        Try
            con = New SqlConnection(cs)
            con.Open()
            cmd = New SqlCommand("SELECT RTRIM(RoomType), RTRIM(Charges) from ExtraBed order by RoomType", con)

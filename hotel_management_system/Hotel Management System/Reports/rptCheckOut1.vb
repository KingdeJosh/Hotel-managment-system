...
Public Class rptCheckOut1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptCheckOut1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckOut1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckOut1 = New rptCheckOut1()
        rpt.Site = Me.Site
        Return rpt
    End Function

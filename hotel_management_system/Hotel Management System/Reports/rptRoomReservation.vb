...
Public Class rptRoomReservation
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptRoomReservation.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRoomReservation
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRoomReservation = New rptRoomReservation()
        rpt.Site = Me.Site
        Return rpt
    End Function

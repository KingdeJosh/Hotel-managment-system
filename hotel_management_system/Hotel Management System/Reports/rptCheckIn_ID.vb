...
Public Class rptCheckIn_ID
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptCheckIn_ID.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckIn_ID
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckIn_ID = New rptCheckIn_ID()
        rpt.Site = Me.Site
        Return rpt
    End Function

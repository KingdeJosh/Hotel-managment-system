...
Public Class rptCheckOut_Room
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptCheckOut_Room.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCheckOut_Room
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCheckOut_Room = New rptCheckOut_Room()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rptRoomOrders
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptRoomOrders.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRoomOrders
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRoomOrders = New rptRoomOrders()
        rpt.Site = Me.Site
        Return rpt
    End Function

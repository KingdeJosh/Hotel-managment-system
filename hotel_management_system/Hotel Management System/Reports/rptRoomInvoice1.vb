...
Public Class rptRoomInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptRoomInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRoomInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRoomInvoice = New rptRoomInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function

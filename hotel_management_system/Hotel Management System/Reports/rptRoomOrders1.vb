...
Public Class rptRoomOrders1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptRoomOrders1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRoomOrders1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRoomOrders1 = New rptRoomOrders1()
        rpt.Site = Me.Site
        Return rpt
    End Function

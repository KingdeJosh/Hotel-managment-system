...
Public Class rptGardenInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptGardenInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGardenInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGardenInvoice = New rptGardenInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function

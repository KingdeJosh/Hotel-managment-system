...
Public Class rptSalarySlips1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptSalarySlips1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_v3() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSalarySlips1
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSalarySlips1 = New rptSalarySlips1()
        rpt.Site = Me.Site
        Return rpt
    End Function

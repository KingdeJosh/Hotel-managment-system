...
Public Class rptHallInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptHallInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptHallInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptHallInvoice = New rptHallInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function

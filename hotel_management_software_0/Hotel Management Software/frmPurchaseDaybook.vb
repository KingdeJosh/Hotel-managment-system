...
Public Class frmPurchaseDaybook
    ...
    Private Sub Button1_Click(sender As System.Object, e As System.EventArgs) Handles Button1.Click
        Try
            ...
            con.Open()
            cmd = New SqlCommand("SELECT ST_ID,Date,InvoiceNo,Name,SubTotal,Discount,FreightCharges,OtherCharges,PreviousDue,GrandTotal from Supplier,Purchase where Supplier.ID=Purchase.SupplierID and PurchaseType='Credit' order by [Date]", con)

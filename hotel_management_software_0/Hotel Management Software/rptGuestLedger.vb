...
Public Class rptGuestLedger
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptGuestLedger.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptGuestLedger
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptGuestLedger = New rptGuestLedger()
        rpt.Site = Me.Site
        Return rpt
    End Function

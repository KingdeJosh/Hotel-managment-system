...
Module ModFunc
    ...
    End Sub
    Sub RefreshRecord1()
        Dim obj As frmGuest = DirectCast(Application.OpenForms("frmGuest"), frmGuest)
        obj.fillIDType()
    End Sub
    Sub RefreshRecord2()
        Dim obj As frmDish = DirectCast(Application.OpenForms("frmDish"), frmDish)
        obj.fillCombo()
    End Sub
    Sub RefreshRecord3()
    ...
    Public Sub GetConnectionStringFromFile()
        ...
        Try
            If My.Computer.FileSystem.FileExists(Application.StartupPath & "\ConnectionString.dat") = False Then
                MsgBox("The file  ConnectionString.dat could not be read, it may not exists, Please consult your admin")
            Else
                Dim GetConnectionStringFromFile As Object = Application.StartupPath & "\ConnectionString.dat"
                End
            End If
        Catch ex As Exception

...
Public Class rptLaundryBilling
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Hotel_Management_System.rptLaundryBilling.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptLaundryBilling
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptLaundryBilling = New rptLaundryBilling()
        rpt.Site = Me.Site
        Return rpt
    End Function
